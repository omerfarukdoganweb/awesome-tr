...
<p align="center">
	<a href="awesome.md">Awesome Listeleri Nedir?</a>&nbsp;&nbsp;&nbsp;
	<a href="contributing.md">Projeye Katkı Rehberi</a>&nbsp;&nbsp;&nbsp;
	<a href="create-list.md">Liste Oluşturma</a>&nbsp;&nbsp;&nbsp;
	<a href="https://twitter.com/awesome__re">Twitter</a>&nbsp;&nbsp;&nbsp;
	<a href="https://www.redbubble.com/people/sindresorhus/works/30364188-awesome-logo">Etiketler & Tişörtler</a>
</p>

<br>

<div align="center">
	<b>Güncellemeler için <a href="https://twitter.com/awesome__re">Awesome Twitter Hesabını</a> takip etmeyi unutmayın.</b>
</div>
...
- [Büyük Veri](#big-data)
- [Bilgisayar Teorileri](#theory)
- [Kitaplar](#books)
- [Kod Editörleri](#editors)
- [Oyun](#gaming)
- [Geliştirme Ortamları](#development-environment)
- [Konu Dışı / Eğlence](#entertainment)
...
- [Çalışma](#work)
- [Ağ](#networking)
- [Dağınık/Merkezi Olmayan Sistemler](#decentralized-systems)
- [İleri Seviye Eğitim](#higher-education)
- [Etkinlikler](#events)
- [Yazılım Testleri](#testing)
- [Diğer](#miscellaneous)
- [İlişkili Konular](#related)
...
- [iOS](https://github.com/vsouza/awesome-ios#readme) - Apple tarafından kendi cihazlari için üretilen mobil işletim sistemi.
- [Android](https://github.com/JStumpp/awesome-android#readme) - Google tarafından kendi cihazlari için üretilen mobil işletim sistemi.
- [IoT & Hybrid Apps](https://github.com/weblancaster/awesome-IoT-hybrid#readme)
- [Electron](https://github.com/sindresorhus/awesome-electron#readme) - HTML/CSS/Javascript ile masaüstü işletim sistemlerine çapraz platform olarak uygulama yazabilmeyi sağlayan yazılım iskeleti.
- [Cordova](https://github.com/busterc/awesome-cordova#readme) - Hibrit uygulamalar için Javascript programlama arayüzü (API).
- [React Native](https://github.com/jondot/awesome-react-native#readme) - IOS ve Android işletim sistemlerine Javascript dili aracılığıyla yerel (Native) uygulamalar yazılmasını sağlayan açık kaynak kodlu uygulama çatısı (framework).
- [Xamarin](https://github.com/XamSome/awesome-xamarin#readme) - Microsoft tarafından üretilen .Net aracılığıyla mobil işletim sistemlerine uygulama yazılmasını amaçlayan platform.
- [Linux](https://github.com/inputsh/awesome-linux#readme)
	- [Konteynerler](https://github.com/Friz-zy/awesome-linux-containers#readme)
	- [eBPF](https://github.com/zoidbergwill/awesome-ebpf#readme) - Virtual machine that allows you to write more efficient and powerful tracing and monitoring for Linux systems.
	- [Arch-bazlı Projeler](https://github.com/PandaFoss/Awesome-Arch#readme) - Linux distributions and projects based on Arch Linux.
...
- [WebExtensions](https://github.com/fregante/Awesome-WebExtensions#readme) - Cross-browser extension system Çapraz-tarayıcılar için .
- [Smart TV](https://github.com/vitalets/awesome-smart-tv#readme) - Farklı TV platformları için uygulama oluşturma.
- [GNOME](https://github.com/Kazhnuz/awesome-gnome#readme) - Linux için basit masaüstü ortamı.
...
- [Amazon Alexa](https://github.com/miguelmota/awesome-amazon-alexa#readme) - Amazon tarafından evler için geliştirilen sanal asistan.
...
- [Home Assistant](https://github.com/frenck/awesome-home-assistant#readme) - Açık kaynaklı ve gizlilik odaklı ev otomasyonu uygulaması.
- [IBM Cloud](https://github.com/victorshinya/awesome-ibmcloud#readme) - IBM tarafından geliştirilen bulut platformu.
- [Firebase](https://github.com/jthegedus/awesome-firebase#readme) - Google tarafından geliştirilen veri odaklı bulut uygulaması.
...
- [Actions on Google](https://github.com/ravirupareliya/awesome-actions-on-google#readme) - Google Asistan ile uygulamalar oluşturmak için kullanılan platform.
- [ESP](https://github.com/agucova/awesome-esp#readme) - Wifi ile uygulamlar oluşturmak için kullanılan düşük maliyetli mikro denetleyiciler.
...
- [Nix](https://github.com/nix-community/awesome-nix#readme) - Linux işletim sistemlerinde güvenlik odaklı paket yöneticisi.
...
- [Low Code](https://github.com/zenitysec/awesome-low-code#readme) - Her alandan profesyonellerin çok düşük kodlama bilgisi ile grafik arayüzü kullanarak uygulamalar oluşturabilmesini sağlayan platform. 
- [Capacitor](https://github.com/riderx/awesome-capacitor#readme) - Çapraz-platform web uygulamaları oluşturmak için kullanılan ortam.
- [ArcGIS Developer](https://github.com/Esri/awesome-arcgis-developer#readme) - Geliştiriciler için haritalandırma ve konum analizi platformu.

## Programming Languages

- [JavaScript](https://github.com/sorrycc/awesome-javascript#readme)
	- [Promises](https://github.com/wbinnssmith/awesome-promises#readme)
	- [Standard Style](https://github.com/standard/awesome-standard#readme) - Stil kılavuzu.
	...
	- [Maintenance Modules](https://github.com/maxogden/maintenance-modules#readme) - NPM paketleri.
	...
	- [ESLint](https://github.com/dustinspecker/awesome-eslint#readme) - Kod analizi.
	- [Functional Programming](https://github.com/stoeffel/awesome-fp-js#readme)
	- [Observables](https://github.com/sindresorhus/awesome-observables#readme)
	- [npm scripts](https://github.com/RyanZim/awesome-npm-scripts#readme) - Task runner.
	- [30 Seconds of Code](https://github.com/30-seconds/30-seconds-of-code#readme) - 30 saniyede anlaşılabilecek kod blokları.
...
- [Python](https://github.com/vinta/awesome-python#readme) - Anlaşılabilirlik odaklı geliştirilen ve popüler programlama dili.
	- [Asyncio](https://github.com/timofurrer/awesome-asyncio#readme) - Asynchronous I/O in Python 3.
	- [Scientific Audio](https://github.com/faroit/awesome-python-scientific-audio#readme) - Ses ve müzik alanında bilimsel araştırmalar.
	- [CircuitPython](https://github.com/adafruit/awesome-circuitpython#readme) - Mikro denetleyiciler için geliştirilen python versiyonu.
	- [Data Science](https://github.com/krzjoa/awesome-python-data-science#readme) - Veri analizi ve makine öğrenmesi.
...
- [Java](https://github.com/akullpp/awesome-java#readme) - "1 defa yaz, her yerde çalıştır" mottosuyla öne çıkan Nesne Tabanlı Programlama dili.
...
- [ActionScript 3](https://github.com/robinrodricks/awesome-actionscript3#readme) - Adobe Air için geliştirilen Nesne Tabanlı Programalama dili.
...
- [CSS](https://github.com/awesome-css-group/awesome-css#readme) - HTML'e ek olarak metin ve format biçimlendirme alanında fazladan olanaklar sunan bir işaretleme dilidir.
	- [Critical-Path Tools](https://github.com/addyosmani/critical-path-css-tools#readme)
	- [Scalability](https://github.com/davidtheclark/scalable-css-reading-list#readme)
	- [Must-Watch Talks](https://github.com/AllThingsSmitty/must-watch-css#readme)
	- [Protips](https://github.com/AllThingsSmitty/css-protips#readme)
	- [Frameworks](https://github.com/troxler/awesome-css-frameworks#readme)
- [React](https://github.com/enaqx/awesome-react#readme) - Javascript ile kullanıcı arayüzleri oluşturmak için kullanılan kitaplık.
	- [Relay](https://github.com/expede/awesome-relay#readme) - Veri odaklı React uygulamaları oluşturmak iöin kullanılan uygulama çatısı (framework).
	- [React Hooks](https://github.com/glauberfc/awesome-react-hooks#readme) - Sınıf kullanmaksızın React'ın tüm özelliklerini kullanmayı sağlayan yapıdır.
- [Web Components](https://github.com/mateusortiz/webcomponents-the-right-way#readme)
- [Polymer](https://github.com/Granze/awesome-polymer#readme) - Web bileşenleri geliştirmek için kullanılan Javascript kütüphanesi.
- [Angular](https://github.com/PatrickJS/awesome-angular#readme) - Typescript ile kullanılan açık kaynak kodlu web uygulama çatısı.
- [Backbone](https://github.com/sadcitizen/awesome-backbone#readme) - MVP mantığı ile geliştirilen açık kaynak kodlu web uygulama çatısı.
- [HTML5](https://github.com/diegocard/awesome-html5#readme) - Web sayfalarını oluşturmak için kullanılan standart metin işaretleme dilidir.
- [SVG](https://github.com/willianjusten/awesome-svg#readme) - XML tabanlı vektörel görüntü formatı.
...
- [Ember](https://github.com/ember-community-russia/awesome-ember#readme) - MVC mantığına uygun olarak tek sayfalık uygulamalar oluşturmayı amaçlayan açık kaynak kodlu uygulama çatısı (framework).
...
- [D3](https://github.com/wbkd/awesome-d3#readme) - Dinamik ve etkileşimli veri görselleştirmeleri üretmek için uygulama kütüphanesi.
- [Emails](https://github.com/jonathandion/awesome-emails#readme)
- [jQuery](https://github.com/petk/awesome-jquery#readme) - DOM manipülasyonu için kullanılan javascript kütüphanesi.
	- [Tips](https://github.com/AllThingsSmitty/jquery-tips-everyone-should-know#readme)
- [Web Audio](https://github.com/notthetup/awesome-webaudio#readme)
- [Offline-First](https://github.com/pazguille/offline-first#readme)
- [Static Website Services](https://github.com/agarrharr/awesome-static-website-services#readme)
- [Cycle.js](https://github.com/cyclejs-community/awesome-cyclejs#readme) - İşlevsel bir javascript uygulama çerçevesi.
...
- [Draft.js](https://github.com/nikgraf/awesome-draft-js#readme) - React için gelişmiş metin düzenleyicisi.
- [Service Workers](https://github.com/TalAter/awesome-service-workers#readme)
- [Progressive Web Apps](https://github.com/TalAter/awesome-progressive-web-apps#readme)
- [choo](https://github.com/choojs/awesome-choo#readme) - App framework.
- [Redux](https://github.com/brillout/awesome-redux#readme) - Javascript için durum kapsayıcısı.
- [Browserify](https://github.com/browserify/awesome-browserify#readme) - Module bundler.
- [Sass](https://github.com/Famolus/awesome-sass#readme) - CSS formatına derlenebilen dinamik bir biçim şablon dilidir.
...
- [Flask](https://github.com/mjhea0/awesome-flask#readme) - Python için mikro web uygulama çatısı.
...
- [IRC](https://github.com/davisonio/awesome-irc#readme) - Açık kaynak kodlu mesajlaşma protokolü.
- [Advertising](https://github.com/cenoura/awesome-ads#readme) - Advertising and programmatic media for websites.
- [Earth](https://github.com/philsturgeon/awesome-earth#readme) - İklim krizinin çözümü için yapılabilecekler.
